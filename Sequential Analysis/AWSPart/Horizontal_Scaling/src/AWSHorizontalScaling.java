...
public class AWSHorizontalScaling {
	...
	public static void main(String[] args) throws Exception {
        ...
        final String ANDREW_ID = text.split("\t")[0];
        final String SUBMISSION_PASSWORD = text.split("\t")[1];
        information.close();
...
//		// Authenticate with load generator.
    ...
    // The sue of ini4j is inspired from [2]&[4]
