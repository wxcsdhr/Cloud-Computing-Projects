...
public class AzureHorizontalScaling {
    ...
    public static void main(String[] args) throws Exception {
        ...
        // Obtain informtaion from accountinformation.txt
        FileReader fileReader = new FileReader(args[0]);
        BufferedReader information = new BufferedReader(fileReader);
        String text = information.readLine();
        subscriptionId = text.split("\t")[0];
        tenantID = text.split("\t")[1];
        applicationID = text.split("\t")[2];
        applicationKey = text.split("\t")[3];
        resourceGroupNameWithVhd = text.split("\t")[4];
        storageAccountName = text.split("\t")[5];
        containerAccountName = text.split("\t")[6];
    ...
    // Following equation is inspired from [1] & [2]
    ...
    // The use of inif4 si inspired from [0] and [4]
