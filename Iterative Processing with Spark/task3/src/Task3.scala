...
object Task3 {
  def main(args: Array[String]){
    ...
    //pass the most popular followee of each followee to the follower
    // user who do not have any followees will be address to 0
    ...
    val secondIteration: VertexRDD[(Double, Long)] = newGraph.aggregateMessages(
      ...
      val output = (secondIteration).map(tuples => s"${tuples._1}\t${tuples._2._2}\t${tuples._2._1}")
