...
public class DriverMatchTask implements StreamTask, InitableTask, WindowableTask {
    ...
    public void process(IncomingMessageEnvelope envelope, MessageCollector collector, TaskCoordinator coordinator) {
	    ...
	    // Handle Driver Location messages
        	...
        	System.out.println("This is a location entry: " + driverLocations.get(key));
		...
		System.out.println("key: " + key + " value: " + driverLocations.get(key));
		...
		Map<String, Object> map = (Map<String, Object>)envelope.getMessage();
        	...
        	if(type.equals("ENTERING_BLOCK") || type.equals("RIDE_COMPLETE")){
        		...
        		double lo = (double)map.get("longitude");
        		String key = blockId + ":" + driverId;
			System.out.println("key: " + key + " entering block, with value: " + driverLocations.get(key));
			...
			System.out.println("After update," + key + " becomes: " + driverLocations.get(key));
			...
			String key = blockId + ":"+ 3333;
			System.out.println("Here is a ride request: " + driverLocations.get(key));
        		while(it.hasNext()){
